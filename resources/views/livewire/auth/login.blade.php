...
<div>
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        <a href="{{ route('home') }}">
            <x-logo class="w-auto h-16 mx-auto text-yellow-100" />
        </a>
        ...
        <p class="mt-2 text-sm text-center text-white leading-5 max-w">
            Or
            <a href="{{ route('register') }}" class="font-medium text-yellow-100 hover:text-yellow-200 focus:outline-none focus:underline transition ease-in-out duration-150">
